    ...
    if($('.city').data('class')){
        ...
        if($('.inner .Size-Type input:eq(0)').val() &&  $('.inner .Size-Type input:eq(1)').val()){
            ...
            if($('.inner .Size-Type input:eq(0)').val() > 0 &&  $('.inner .Size-Type input:eq(1)').val() > 0){
                ...
                AnswersCurtain[3] ={'Tell us the size(s) of your Curtain(s)' : {'X' :`${$('.inner .Size-Type input:eq(0)').val()} ${$('.inner .Size-Type .unit').text()}` , 'Y':`${$('.inner .Size-Type input:eq(1)').val()} ${$('.inner .Size-Type .unit').text()}`}}
